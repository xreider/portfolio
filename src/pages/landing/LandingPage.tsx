    ...
    <>
      ...
      <div className={cls.section}>
        ...
        <div className={cls.subsection}>
          ...
          <p className={'muted'}>
            Использую для тестирования гипотез
          </p>
          <p>
            <ExternalLink href='https://v0.dev/' accent='high'>v0.dev</ExternalLink>, <ExternalLink href='https://lovable.dev/' accent='high'>lovable.dev</ExternalLink>, <ExternalLink href='https://studio.firebase.google.com/' accent='high'>studio.firebase.google.com</ExternalLink> (понимает только английский), <ExternalLink href='https://bolt.new/' accent='high'>bolt.new</ExternalLink>, <ExternalLink href='https://adaptive.ai/' accent='high'>adaptive.ai</ExternalLink>, <ExternalLink href='https://replit.com/' accent='high'>replit.com</ExternalLink>  (понимает только английский), <ExternalLink href='https://gamma.app/' accent='high'>gamma.app</ExternalLink>, <ExternalLink href='https://stitch.withgoogle.com/' accent='high'>stitch.withgoogle.com</ExternalLink>
          </p>
        </div>
        <div className={cls.subsection}>
          <h4>Изображения</h4>
